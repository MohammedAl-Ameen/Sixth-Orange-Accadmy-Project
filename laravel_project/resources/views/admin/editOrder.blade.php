            ...
            <div class="row">
              <div class="col-md-6 pr-1">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{$order->order_name}}" name='oname'>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6 pr-1">
                <div class="form-group">
                  ...
                  <textarea class="form-control" style="height:100px" name="odescription" placeholder=".....">value="{{$order->order_description}}</textarea>
                </div>
              </div>
            </div>
            <div class="row">
